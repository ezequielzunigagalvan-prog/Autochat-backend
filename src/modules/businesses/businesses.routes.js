...
const widgetStyleValues = ["premium", "minimal", "industrial", "salud", "elegante"];
const widgetPositionValues = ["right", "left"];
const widgetQuickReplySchema = z.array(z.object({
...
const businessSchema = z.object({
  ...
  widgetStyle: z.enum(widgetStyleValues).optional().default("premium"),
  widgetPrimaryColor: z.string().optional().default("#1f5c50"),
  widgetSecondaryColor: z.string().optional().default("#2f7a68"),
  widgetAccentColor: z.string().optional().default("#c66d42"),
  widgetBackgroundColor: z.string().optional().default("#f7f8f6"),
  widgetLauncherText: z.string().optional().default("Chat"),
  widgetAvatarText: z.string().optional().default("AI"),
  widgetPosition: z.enum(widgetPositionValues).optional().default("right"),
  widgetRadius: z.coerce.number().int().min(8).max(32).optional().default(24),
  widgetQuickReplies: widgetQuickReplySchema,
  widgetContactTitle: z.string().optional().default("Datos de contacto"),
  widgetContactIntro: z.string().optional().default("Para que el equipo pueda darte seguimiento, déjame tus datos."),
...
const businessUpdateSchema = z.object({
  ...
  widgetStyle: z.enum(widgetStyleValues).optional(),
  ...
  widgetLauncherText: z.string().optional(),
  widgetAvatarText: z.string().optional(),
  widgetPosition: z.enum(widgetPositionValues).optional(),
  widgetRadius: z.coerce.number().int().min(8).max(32).optional(),
  widgetQuickReplies: widgetQuickReplySchema.optional(),
  widgetContactTitle: z.string().optional(),
  widgetContactIntro: z.string().optional(),
    ...
    const business = await prisma.$transaction(async (tx) => {
      const created = await tx.business.create({
        data: {
          ...
          widgetStyle: parsed.widgetStyle,
          widgetPrimaryColor: parsed.widgetPrimaryColor,
          widgetSecondaryColor: parsed.widgetSecondaryColor,
          widgetAccentColor: parsed.widgetAccentColor,
          widgetBackgroundColor: parsed.widgetBackgroundColor,
          widgetLauncherText: parsed.widgetLauncherText,
          widgetAvatarText: parsed.widgetAvatarText,
          widgetPosition: parsed.widgetPosition,
          widgetRadius: parsed.widgetRadius,
          widgetQuickReplies: JSON.stringify(parsed.widgetQuickReplies || []),
          widgetContactTitle: parsed.widgetContactTitle,
          widgetContactIntro: parsed.widgetContactIntro,
    ...
    const business = await prisma.$transaction(async (tx) => {
      ...
      return tx.business.update({
        ...
        data: {
          ...
          widgetPosition: parsed.widgetPosition,
          widgetRadius: parsed.widgetRadius,
          widgetQuickReplies: parsed.widgetQuickReplies ? JSON.stringify(parsed.widgetQuickReplies) : undefined,
          widgetContactTitle: parsed.widgetContactTitle,
          widgetContactIntro: parsed.widgetContactIntro,
          whatsappSender: parsed.whatsappSender,
          whatsappProvider: parsed.whatsappProvider,
